        ...
        static void Main(string[] args)
        {
            ...
            Teams team = new Teams();
                ...
                if (Auswahl == "1")
                {
                    ...
                    Console.WriteLine("Möchten sie einen Spieler erstellen(1), alle Spieler anzeigen(2) oder alle löschen(3)");
                    ...
                    {
                        Console.WriteLine("GANZE Tabelle löschen? Ja/Nein");
                        string AuswahlLöschen = Console.ReadLine();
                        if (AuswahlLöschen == "Ja")
                        {
                        person.ClearTable();
                        person.ClearTableAddress();
                        }
                        else if (AuswahlLöschen == "Nein")
                        {
